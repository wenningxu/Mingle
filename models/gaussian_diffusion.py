...
class MotionDiffusion(GaussianDiffusion):
    ...
    def ddim_sample_control(
        ...
        loss, gradient = self.gradients(pred_x_start, x)
        sample = sample - gradient
        ...
        for i in indices:
            ...
            for j in range(n_person):
                with th.no_grad():
                    ...
                    # count = th.sum((out['pred_xstart'] <= -1) | (out['pred_xstart'] >= 1))
                    # print(count)
